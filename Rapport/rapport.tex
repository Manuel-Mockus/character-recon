...
\begin{center}
\captionof{table}{Chiffres les plus souvent confondus par norme de Minkowsky}
\begin{tabular}{ |c||c|c|c|c|c|c|c|c|c|c|c| } 
\hline
...
\begin{figure}[H]
\begin{center}
  	\includegraphics[width=0.8\linewidth]{Graphs/Distance_bases_20_1.png}
  	\caption{Moindres carrés de tous les 1 du test (20 vecteurs de base). On remarque une bonne identification des chiffres.}
  	\end{center}
\end{figure}
...
\begin{center}
  	...
  	\includegraphics[width=0.8\linewidth]{Graphs/Distance_bases_20_3.png}
  	\caption{Moindres carrés de tous les 3 du test (20 vecteurs de base). Le graphique montre la difficulté de classifier les 3 (relativement par rapport aux 1).}
\end{center}
\end{figure}
...
Le premier set de test a été effectué pour des valeurs du seuil entre 0.9 et 1 (des valeurs inférieures du seuil donnant un taux de rejet trop élevées env. 20\%) et une valeur de k (nombre de vecteurs de base) entre 1 et 7 (Figure 4.1).\\
...
\begin{figure}[H]
  	...
  	\caption{Performance pour chaque chiffre et en moyenne en fonction du nombre de vecteurs de base.}
\end{figure}
...
Pour le premier algorithme nous avons testé 50 fois, obtenant en moyenne des performances de 83\% pour la norme 2 et 84\% pour la norme 2 (Table 5.1) avec des résultats variées en fonction des chiffres analysés.
