...
\begin{center}
  	...
  	\caption{Moindres carres de toutes les 1 de test (20 vecteurs de base). On remarque une bonne identification des chiffres.}
  	\end{center}
\end{figure}
...
\begin{center}
  	...
  	\caption{Moindres carres de toutes les 1 de test (20 vecteurs de base). Le graphique montre la difficulté de classifier les 3 (relatvement par rapport aux 1.}
\end{center}
\end{figure}
