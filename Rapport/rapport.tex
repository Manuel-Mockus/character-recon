...
%Inserer conclusion temporaire, meme si on modifie ulterieurement avec les resultats des autres, on peut faire un poin sur le temps de calcul, et la relative efficacité de l'lagorithme.
