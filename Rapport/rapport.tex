...
On remarque que la distance tangente permet d’améliorer substantiellement la résistance au bruit de l'algorithme des écarts à la moyenne. Cependant la méthode de décomposition en valeurs singulières offre de meilleurs résultats, même sur un base bruitée.
