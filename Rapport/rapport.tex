...
\subsubsection{Seuillage}%pourrait aller dans la partie pratique
...
\begin{figure}[H]
  	\includegraphics[width=\linewidth]{"test600bases".png}
  	\caption{A Ajouter}
\end{figure}

\begin{figure}[H]
  	\includegraphics[width=\linewidth]{"test30bases".png}
  	\caption{A Ajouter}
\end{figure}
